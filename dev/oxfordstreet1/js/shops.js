...
(function() {
    ...
    const SAMPLE_SHOPS = [
        ...
        },
        {
            ...
            description: 'British retailer famous for quality clothing, home products and food. A trusted brand for over 130 years.',
            logo: 'assets/shops/marks-spencer-logo.jpg',
        ...
        },
        {
            ...
            category: 'fashion',
            location: 'oxford-circus',
            address: '325 Oxford Street, London W1C 2HF',
            description: 'British fashion retailer offering contemporary clothing, footwear and accessories for men, women and children.',
            logo: 'assets/shops/next-logo.jpg',
            website: 'https://www.next.co.uk',
            phone: '+44 20 7629 6000',
        ...
        },
        {
            ...
            location: 'oxford-circus',
            address: '300 Oxford Street, London W1C 1DX',
            description: 'Leading pharmacy-led health and beauty retailer offering medicines, beauty products, and health services.',
            logo: 'assets/shops/boots-logo.jpg',
            website: 'https://www.boots.com',
            phone: '+44 20 7491 8546',
            email: 'customer.care@boots.co.uk',
            hours: {
                monday: '08:00 - 22:00',
                tuesday: '08:00 - 22:00',
        ...
        },
        {
            ...
            description: 'Japanese casual wear designer, manufacturer and retailer known for innovative fabrics and minimalist designs.',
            logo: 'assets/shops/uniqlo-logo.jpg',
            website: 'https://www.uniqlo.com/uk',
            phone: '+44 20 7290 7701',
            email: 'info@uniqlo.co.uk',
            hours: {
                monday: '10:00 - 21:00',
                tuesday: '10:00 - 21:00',
                wednesday: '10:00 - 21:00',
        ...
        },
        {
            ...
            address: '14-18 Oxford Street, London W1D 1AR',
            description: 'Irish fast-fashion retailer offering affordable clothing, accessories, and home goods for the whole family.',
            logo: 'assets/shops/primark-logo.jpg',
            website: 'https://www.primark.com',
            phone: '+44 20 7580 5510',
            email: 'customer.advice@primark.co.uk',
            hours: {
                monday: '08:00 - 22:00',
                tuesday: '08:00 - 22:00',
                wednesday: '08:00 - 22:00',
        ...
        },
        {
            ...
            description: 'Premium department store offering luxury fashion, beauty, home and lifestyle products from leading brands.',
            logo: 'assets/shops/house-of-fraser-logo.jpg',
            website: 'https://www.houseoffraser.co.uk',
            phone: '+44 20 7629 8800',
            email: 'customer.services@houseoffraser.co.uk',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'electronics',
            location: 'tottenham-court',
            address: '67-83 Oxford Street, London W1D 2EJ',
            description: 'Leading technology retailer offering computers, gaming, mobile phones, and home appliances with expert advice.',
            logo: 'assets/shops/currys-logo.jpg',
            website: 'https://www.currys.co.uk',
            phone: '+44 20 7636 8811',
            email: 'help@currys.co.uk',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'sports',
            location: 'oxford-circus',
            address: '363-367 Oxford Street, London W1C 2JL',
            description: 'Leading retailer of sports fashion, footwear and accessories from top brands like Nike, Adidas, and more.',
            logo: 'assets/shops/jd-sports-logo.jpg',
            website: 'https://www.jdsports.co.uk',
            phone: '+44 20 7580 9298',
        ...
        },
        {
            ...
            category: 'beauty',
            location: 'oxford-circus',
            address: '375 Oxford Street, London W1C 2JF',
            description: 'Ethical beauty brand offering natural skincare, makeup, and fragrance products with a commitment to sustainability.',
            logo: 'assets/shops/body-shop-logo.jpg',
            website: 'https://www.thebodyshop.com',
            phone: '+44 20 7409 7868',
            email: 'help@thebodyshop.com',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'sports',
            location: 'oxford-circus',
            address: '15 Oxford Street, London W1D 1AR',
            description: 'Official Adidas store featuring the latest sportswear, sneakers, and lifestyle products from the iconic three-stripes brand.',
            logo: 'assets/shops/adidas-logo.jpg',
            website: 'https://www.adidas.co.uk',
            phone: '+44 20 7379 8885',
            email: 'consumer.services@adidas.co.uk',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'luxury',
            location: 'oxford-circus',
            address: '131 Oxford Street, London W1D 2HZ',
            description: 'Danish jewelry brand famous for customizable charm bracelets, rings, earrings, and necklaces.',
            logo: 'assets/shops/pandora-logo.jpg',
            website: 'https://uk.pandora.net',
            phone: '+44 20 7580 9933',
            email: 'service@pandora.net',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'fashion',
            location: 'oxford-circus',
            address: '200 Oxford Street, London W1W 9RY',
            description: 'Lifestyle retailer offering trendy fashion, accessories, shoes, beauty, and home decor for young adults.',
            logo: 'assets/shops/urban-outfitters-logo.jpg',
            website: 'https://www.urbanoutfitters.com/uk',
            phone: '+44 20 7907 0800',
            email: 'help@urbanoutfitters.co.uk',
            hours: {
                monday: '10:00 - 21:00',
                tuesday: '10:00 - 21:00',
                wednesday: '10:00 - 21:00',
        ...
        },
        {
            ...
            description: 'Leading bookstore chain offering books, eBooks, audiobooks, and literary events in a welcoming environment.',
            logo: 'assets/shops/waterstones-logo.jpg',
            website: 'https://www.waterstones.com',
            phone: '+44 20 7851 2400',
            email: 'help@waterstones.com',
            hours: {
                monday: '09:00 - 21:00',
                tuesday: '09:00 - 21:00',
                wednesday: '09:00 - 21:00',
        ...
        },
        {
            ...
            category: 'beauty',
            location: 'oxford-circus',
            address: '123 Oxford Street, London W1D 2HU',
            description: 'Handmade cosmetics company offering fresh, cruelty-free bath bombs, soaps, shampoos, and skincare products.',
            logo: 'assets/shops/lush-logo.jpg',
            website: 'https://uk.lush.com',
            phone: '+44 20 7240 4570',
        ...
        },
        {
            ...
            category: 'fashion',
            location: 'oxford-circus',
            address: '354-366 Oxford Street, London W1C 1JH',
            description: 'American clothing and accessories retailer known for casual wear including jeans, t-shirts, and khakis for all ages.',
            logo: 'assets/shops/gap-logo.jpg',
            website: 'https://www.gap.co.uk',
            phone: '+44 20 7408 4500',
            email: 'customercare@gap.com',
            hours: {
                monday: '10:00 - 21:00',
                tuesday: '10:00 - 21:00',
                wednesday: '10:00 - 21:00',
        ...
        },
        {
            ...
            category: 'footwear',
            location: 'oxford-circus',
            address: '57 Oxford Street, London W1D 2EF',
            description: 'Contemporary footwear retailer offering the latest trends in shoes, boots, and trainers from leading brands.',
            logo: 'assets/shops/office-logo.jpg',
            website: 'https://www.office.co.uk',
            phone: '+44 20 7379 1896',
            email: 'customer.services@office.co.uk',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'services',
            location: 'oxford-circus',
            address: '150 Oxford Street, London W1D 1DJ',
            description: 'Entertainment retailer specializing in music, movies, games, and pop culture merchandise with exclusive releases.',
            logo: 'assets/shops/hmv-logo.jpg',
            website: 'https://www.hmv.com',
            phone: '+44 20 7631 3423',
            email: 'help@hmv.com',
            hours: {
                monday: '09:00 - 21:00',
                tuesday: '09:00 - 21:00',
        ...
        },
        {
            ...
            location: 'oxford-circus',
            address: '29 Oxford Street, London W1D 2DR',
            description: 'Fashion accessories retailer offering bags, jewelry, scarves, hats, and travel accessories with global inspiration.',
            logo: 'assets/shops/accessorize-logo.jpg',
            website: 'https://uk.accessorize.com',
            phone: '+44 20 7493 3642',
            email: 'customercare@accessorize.com',
            hours: {
                monday: '10:00 - 20:00',
                tuesday: '10:00 - 20:00',
                wednesday: '10:00 - 20:00',
        ...
        },
        {
            ...
            category: 'food',
            location: 'oxford-circus',
            address: '421 Oxford Street, London W1C 2PF',
            description: 'Popular food chain serving freshly made sandwiches, salads, hot food, and organic coffee made on-site daily.',
            logo: 'assets/shops/pret-logo.jpg',
            website: 'https://www.pret.co.uk',
            phone: '+44 20 7629 1718',
            email: 'customercare@pret.co.uk',
            hours: {
                monday: '06:30 - 21:00',
                tuesday: '06:30 - 21:00',
