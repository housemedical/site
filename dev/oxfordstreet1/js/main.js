...
(function() {
    ...
    function initializeImageHandling() {
        ...
        allImages.forEach(img => {
            ...
            // Set up fallback placeholder if image is missing
    ...
    function createImagePlaceholder(img) {
        // Don't create placeholder if one already exists
        ...
        // Get meaningful alt text or create generic text
        const altText = img.alt || 'Image';
        placeholder.innerHTML = `
            <div style="padding: 20px;">
                <i class="fas fa-image" style="font-size: 24px; margin-bottom: 8px; opacity: 0.5;"></i><br>
                <span>${altText}</span>
            </div>
        `;
